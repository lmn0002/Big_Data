...
Step 4: Build and Run the Pipeline with Docker
...
Step 5: Run Jupyter Notebook for Data Ingestion


Copy
uv add --dev jupyter
uv run jupyter notebook
In the notebook, run the ingestion script to load the NYC taxi data into PostgreSQL.

Step 6: Connect to PostgreSQL and Verify
